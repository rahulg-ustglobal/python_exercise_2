...
class sales_transaction:
    ...
    # -self.sale_order_record.get('order_lines').get([v for v in self.sale_order_record.get('order_lines')])

    # {'customer': 'cus_1',
    #  'order_lines': [{'product_sku': 'PRD1', 'unit_price': 12, 'quantity': 2, 'subtotal': 24, 'state': 'Draft'}],
    #  'order_date': '20/08/2021', 'state': 'Draft', 'order_total_amount': 24}
    ...
    def draft_state(self):
        for var_draft in self.sale_order_record[self.choice_sale_order]['order_lines']:
            if var_draft['state'] == 'Draft':
                ...
                self.sale_order_record['state'] = 'Draft'
    ...
    def print_bill(self):
        ...
        if choice_sale_order in self.sale_order_record:
            ...
            print("=================================================================")
            # print(f"				                        Order Total - 2334908.00")
